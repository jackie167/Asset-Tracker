...
const CURRENT_ASSET_SHEET = "Current asset - CURRENT ASSETS";
...
function parseCurrentAssetRows(rows: Array<Array<string | number>>): HoldingItem[] {
...
export default function WealthAllocationPage() {
  ...
  const loadWealthAllocation = useCallback(async () => {
    ...
    try {
      ...
      setHoldings(parseCurrentAssetRows(rows));
    } catch (err) {
